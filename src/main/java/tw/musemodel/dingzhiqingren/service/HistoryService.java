...
public class HistoryService {
        ...
        public List<Activity> findActiveLogsOrderByOccurredDesc(Lover lover) {
                ...
                for (History history : historyRepository.findByInitiativeAndBehaviorNotInOrderByIdDesc(lover, BEHAVIORS_ANNO_IGNORE)) {
                ...
                for (History history : historyRepository.findByPassiveAndBehaviorNotInOrderByIdDesc(lover, BEHAVIORS_ANNO_IGNORE)) {
                        Activity activeLogs = new Activity(
                                history.getId(),
