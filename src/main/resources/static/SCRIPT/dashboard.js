$(document).ready(function () {
	...
	// 複製連結
	$('DIV#copyDepositLink').click(function () {
		var content =
			`${hostName}/dashboard/financialStatementOfDeposit.xls?since=${sinceYear}-${sinceMonth < 10 ? '0' + sinceMonth : sinceMonth}-01
	...
	// 複製連結
	$('DIV#copyWithdrawalLink').click(function () {
		var content =
			`${hostName}/dashboard/financialStatementOfWithdrawal.xls?since=${sinceYear}-${sinceMonth < 10 ? '0' + sinceMonth : sinceMonth}-01
				&until=${currentYear}-${currentMonth < 10 ? '0' + currentMonth : currentMonth}-${currentDate < 10 ? '0' + currentDate : currentDate}`;
