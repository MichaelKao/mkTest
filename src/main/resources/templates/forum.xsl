                                ...
                                <DIV class="addPost col-md-10 col-lg-8 col-xl-6 mx-auto">
                                        <DIV class="post">
                                                ...
                                                <DIV class="postFooter">
                                                        <TEXTAREA class="form-control text-white addPostTextarea" rows="3" placeholder="想說點什麼..."></TEXTAREA>
                                                        <DIV class="d-flex mt-2">
                                                                <DIV class="addImages text-white cursor-pointer position-relative">
                                                                        <I class="fas fa-images fontSize22" aria-hidden="true"></I>
                                                                        <I class="fas fa-plus position-absolute text-xs top-1"></I>
                                                                </DIV>
                                                                <DIV class="ms-auto">
                                                                        <BUTTON class="btn btn-link btn-round text-white text-lg m-0 p-0">發佈</BUTTON>
                                                                </DIV>
                                                        </DIV>
                                                </DIV>
                                        </DIV>
